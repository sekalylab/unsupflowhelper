...
#'
#'
CreateFlowObject <- function(flowSet,
                             name,
                             subsample = 5000,
                             min_events = 500,
  ...
  fileLS <- flowWorkspace::sampleNames(flowSet)
  ...
  fS_filt <- Downsampling_FlowSet(flowSet[fileLS_filt], n = minLines )
  ...
  param_LS <- list("exclude_markers" = list(),
                   "include_markers" = flowCore::markernames(flowSet),
                   "cofactor_find" = FALSE)
